...
public class OVRCardboard : MonoBehaviour
{
	...
	private OVRCardboardController CameraController = null;
	...
	void Start()
	{
		...
		CameraController = gameObject.transform.parent.GetComponent<OVRCardboardController>();
	...
	{	
		...
		if(RightEye) {
			model.transform.rotation = Quaternion.Inverse (q) * modelRotation;
		}
		// * * *
